...
if a>=b
    X = abs(round(x + (a * cosalpha * cosbeta - b * sinalpha * sinbeta))); 
    Y = abs(round(y + (a * cosalpha * sinbeta + b * sinalpha * cosbeta)));
elseif a <b
    X = abs(round(x + (b * cosalpha * cosbeta - a * sinalpha * sinbeta))); 
    Y = abs(round(y + (b * cosalpha * sinbeta + a * sinalpha * cosbeta)));
end
